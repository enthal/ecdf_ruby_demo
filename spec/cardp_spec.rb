...
describe 'cardp' do
  ...
  describe '#card_present_ratios_for_each_spending_bucket' do
    ...
    it { card_present_ratios_for_each_spending_bucket(cpag).map{|x|x.to_a.sort}.should == [[7.0/9, 19.0/23], [13.0/17]] }
  end
